...
**flowchrt Program**
![fl1](https://raw.githubusercontent.com/mdidanraihanabdillah/Praktikum4/master/flow1.jpg)
...
int main ()
{
    cout<< "M.Didan Raihan Abdillah"<<endl;
...
```
**HASIL**
![hasil1](https://raw.githubusercontent.com/mdidanraihanabdillah/Praktikum4/master/hasil1.png)
...
**Flowchart Program**
![fl3](https://raw.githubusercontent.com/mdidanraihanabdillah/Praktikum4/master/flow2.jpg)
...
int main ()
{
    ...
    cout<< "|              Muhammad Didan Raihan Abdillah                   |"<<endl;
    cout<< "|-----------------------------------------------------|"<<endl;
    cout<< "| Praktikum4"<< "Program Menghitung Total Belanja     |"<< endl;
    cout<< "|-----------------------------------------------------|" <<endl;
...
**HASIL**
![hasil3](https://raw.githubusercontent.com/mdidanraihanabdillah/Praktikum4/master/hasil2.png)
